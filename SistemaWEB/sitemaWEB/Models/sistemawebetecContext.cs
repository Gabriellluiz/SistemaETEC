...
{
    public partial class sistemawebetecContext : DbContext
    {
        public sistemawebetecContext()
        {
        }

        public sistemawebetecContext(DbContextOptions<sistemawebetecContext> options)
            : base(options)
        {
        }
